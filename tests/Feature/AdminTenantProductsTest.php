...
class AdminTenantProductsTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_admin_can_view_tenant_product_detail(): void
    {
        $admin = $this->makeAdmin();
        $this->actingAs($admin, 'admin');

        [$tenant, $tenantDb] = $this->provisionTenantWithDb('tenant_product_detail_' . uniqid());
        ...
        $response = $this->get(route('admin.tenants.products.show', [$tenant->id, $product->id]));
